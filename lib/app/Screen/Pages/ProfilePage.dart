...
import 'ProfilePages/DiscptionPage.dart';
import 'ProfilePages/TrackOrderPage.dart';
import 'ProfilePages/VaccineSchedule.dart';
                                    ...
                                    if (index == 0) {
                                      ...
                                      return Container(
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: (){Get.to(const PetSearch());},
                                        ),
                                      );
                                    } else {
                                      // Display selected image
                                      return InkWell(
                                        onTap: (){Get.to(DescriptionPage(context,controller.users.value.petDescription[index-1],false));},
                                        child: Container(
                                          decoration: BoxDecoration(
